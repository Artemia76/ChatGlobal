	...
	)
{
	...
	item35->Add( item25, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	item38->Add( item39, 0, wxALIGN_CENTER|wxALL, 5 );
	item38->Add( item40, 0, wxALIGN_CENTER|wxALL, 5 );
	item35->Add( item38, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	item41->Add( item42, 0, wxALIGN_CENTER|wxALL, 5 );
	item41->Add( item43, 0, wxALIGN_CENTER|wxALL, 5 );
	item35->Add( item41, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	...
	item37->Add( item28, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	item44->Add( item45, 0, wxALIGN_CENTER|wxALL, 5 );
	item44->Add( item46, 0, wxALIGN_CENTER|wxALL, 5 );
	item37->Add( item44, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	item47->Add( item48, 0, wxALIGN_CENTER|wxALL, 5 );
	item47->Add( item49, 0, wxALIGN_CENTER|wxALL, 5 );
	item37->Add( item47, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	...
	item0->Add( item31, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	SetAutoLayout (true);
	SetSizer( item0 );
	item0->Fit(this);
